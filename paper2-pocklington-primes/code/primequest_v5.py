...
# ───────────────────────────────────────────────────────────────
# CENTRE — ratio b/a = 1.0
# ───────────────────────────────────────────────────────────────
# Résultats observés :
#   19 999 ch. (a=12228, b=13242) : b/a = 1.083
#   29 998 ch. (a=19435, b=19173) : b/a = 0.987
# La moyenne est proche de 1.0 → centre le plus robuste
RATIO_B_SUR_A   = 1.000       # ratio b/a empirique
...
def _tester_paire(args):
    ...
    # Confirmation avant Pocklington (élimine les rares faux positifs)
